...
$sequencePath = Join-Path (Join-Path $repoRoot ".github") "launcher-polish-sequence.json"
$issueDir = Join-Path (Join-Path (Join-Path $repoRoot ".github") "issues") "launcher-polish"
...
$labels = @(
    ...
    @{ name = "pass-2"; color = "6AA8E3"; description = "Pass 2: Icons and Header" }
    @{ name = "pass-3"; color = "4591D9"; description = "Pass 3: Data and Screens" }
    @{ name = "pass-4"; color = "207ACF"; description = "Pass 4: Settings and Polish" }
...
Write-Host ""
Write-Host "  The chain will automatically assign the next phase when each PR merges." -ForegroundColor DarkGray
Write-Host "=================================================" -ForegroundColor Cyan
